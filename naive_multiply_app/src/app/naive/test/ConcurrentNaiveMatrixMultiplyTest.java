...
public class ConcurrentNaiveMatrixMultiplyTest {
	
	@Test
	public void testSimpleMultiply() {
		Matrix m1 = new Matrix(1, 1, 3);
		Matrix m2 = new Matrix(1, 1, 3);
		int data[][] = ConcurrentNaiveMatrixMultiplier.multiply(m1.getArray(), m2.getArray());
	...
	public void testBadDemensions1() {
		...
		ConcurrentNaiveMatrixMultiplier.multiply(m1.getArray(), m2.getArray());
	}
